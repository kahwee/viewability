...
const states = {
  after: 'EL_IS_BELOW_VIEW',
  before: 'EL_IS_ABOVE_VIEW',
  within: 'EL_IS_WITHIN_VERTICAL_VIEW',
  bothTruncated: 'EL_BOTTOM_AND_TOP_TRUNCATED',
  startTruncated: 'EL_TOP_TRUNCATED',
  endTruncated: 'EL_BOTTOM_TRUNCATED',
